...
import {$StructureAfterPlaceEventJS, $StructureAfterPlaceEventJS$$Type} from "com.almostreliable.morejs.features.structure.StructureAfterPlaceEventJS"
...
import {$LootTableEventJS, $LootTableEventJS$$Type} from "com.almostreliable.lootjs.kube.LootTableEventJS"
...
import {$CustomFilterKubeEvent, $CustomFilterKubeEvent$$Type} from "dev.ftb.mods.ftbxmodcompat.neoforge.ftbfiltersystem.kubejs.CustomFilterKubeEvent"
...
import {$StartTradingEventJS, $StartTradingEventJS$$Type} from "com.almostreliable.morejs.features.villager.events.StartTradingEventJS"
import {$VillagerTradingEventJS, $VillagerTradingEventJS$$Type} from "com.almostreliable.morejs.features.villager.events.VillagerTradingEventJS"
...
import {$PlayerEnchantEventJS, $PlayerEnchantEventJS$$Type} from "com.almostreliable.morejs.features.enchantment.PlayerEnchantEventJS"
...
import {$CustomRewardKubeEvent, $CustomRewardKubeEvent$$Type} from "dev.ftb.mods.ftbxmodcompat.neoforge.ftbquests.kubejs.CustomRewardKubeEvent"
import {$AfterEventJS, $AfterEventJS$$Type} from "dev.ftb.mods.ftbxmodcompat.neoforge.ftbchunks.kubejs.AfterEventJS"
import {$EntityTeleportsEventJS, $EntityTeleportsEventJS$$Type} from "com.almostreliable.morejs.features.teleport.EntityTeleportsEventJS"
import {$BlockBrokenKubeEvent, $BlockBrokenKubeEvent$$Type} from "dev.latvian.mods.kubejs.block.BlockBrokenKubeEvent"
import {$PlayerTeamKubeEvent, $PlayerTeamKubeEvent$$Type} from "dev.ftb.mods.ftbxmodcompat.neoforge.ftbteams.kubejs.PlayerTeamKubeEvent"
import {$ItemPickedUpKubeEvent, $ItemPickedUpKubeEvent$$Type} from "dev.latvian.mods.kubejs.item.ItemPickedUpKubeEvent"
import {$PotionBrewingRegisterEvent, $PotionBrewingRegisterEvent$$Type} from "com.almostreliable.morejs.features.potion.PotionBrewingRegisterEvent"
...
import {$StructureLoadEventJS, $StructureLoadEventJS$$Type} from "com.almostreliable.morejs.features.structure.StructureLoadEventJS"
import {$PowerfulInterceptTickingEvent, $PowerfulInterceptTickingEvent$$Type} from "moe.wolfgirl.powerfuljs.events.PowerfulInterceptTickingEvent"
import {$QuestObjectCompletedKubeEvent, $QuestObjectCompletedKubeEvent$$Type} from "dev.ftb.mods.ftbxmodcompat.neoforge.ftbquests.kubejs.QuestObjectCompletedKubeEvent"
...
import {$BeforeEventJS, $BeforeEventJS$$Type} from "dev.ftb.mods.ftbxmodcompat.neoforge.ftbchunks.kubejs.BeforeEventJS"
...
import {$LootModificationEventJS, $LootModificationEventJS$$Type} from "com.almostreliable.lootjs.kube.LootModificationEventJS"
...
import {$EnchantmentTableServerEventJS, $EnchantmentTableServerEventJS$$Type} from "com.almostreliable.morejs.features.enchantment.EnchantmentTableServerEventJS"
import {$RandomTickKubeEvent, $RandomTickKubeEvent$$Type} from "dev.latvian.mods.kubejs.block.RandomTickKubeEvent"
import {$PiglinPlayerBehaviorEventJS, $PiglinPlayerBehaviorEventJS$$Type} from "com.almostreliable.morejs.features.misc.PiglinPlayerBehaviorEventJS"
import {$WandererTradingEventJS, $WandererTradingEventJS$$Type} from "com.almostreliable.morejs.features.villager.events.WandererTradingEventJS"
...
import {$CustomTaskKubeEvent, $CustomTaskKubeEvent$$Type} from "dev.ftb.mods.ftbxmodcompat.neoforge.ftbquests.kubejs.CustomTaskKubeEvent"
...
import {$ExperiencePlayerEventJS, $ExperiencePlayerEventJS$$Type} from "com.almostreliable.morejs.features.misc.ExperiencePlayerEventJS"
import {$QuestObjectStartedKubeEvent, $QuestObjectStartedKubeEvent$$Type} from "dev.ftb.mods.ftbxmodcompat.neoforge.ftbquests.kubejs.QuestObjectStartedKubeEvent"
...
export namespace FTBFilterSystemEvents {
...
function playerEnchant(handler: (event: $PlayerEnchantEventJS) => void): void
...
function updateOffer(handler: (event: $UpdateOfferEventJS) => void): void
function isEnchantable(handler: (event: $EnchantmentTableServerEventJS) => void): void
function villagerTrades(handler: (event: $VillagerTradingEventJS) => void): void
}
export namespace PowerfulEvents {
function interceptTicking(handler: (event: $PowerfulInterceptTickingEvent) => void): void
}
...
export namespace FTBChunksEvents {
