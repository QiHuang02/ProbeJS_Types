...
import {$CustomFilterItemKubeEvent, $CustomFilterItemKubeEvent$$Type} from "dev.ftb.mods.ftbxmodcompat.neoforge.ftbquests.kubejs.CustomFilterItemKubeEvent"
import {$EnchantmentTableTooltipEventJS, $EnchantmentTableTooltipEventJS$$Type} from "com.almostreliable.morejs.features.enchantment.EnchantmentTableTooltipEventJS"
...
function customFilterItem(handler: (event: $CustomFilterItemKubeEvent) => void): void
}
}